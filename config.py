...
# Optional SOCKS5 proxy for SFTP only (whitelist the proxy egress IP in SFTPCloud).
# Set IDEAS_SFTP_PROXY=socks5://user:pass@host:port OR use IDEAS_SFTP_PROXY_HOST/PORT/USERNAME/PASSWORD.
IDEAS_SFTP_PROXY = os.getenv("IDEAS_SFTP_PROXY", "").strip()
IDEAS_SFTP_PROXY_TYPE = os.getenv("IDEAS_SFTP_PROXY_TYPE", "socks5").strip().lower()
IDEAS_SFTP_PROXY_HOST = os.getenv("IDEAS_SFTP_PROXY_HOST", "").strip()
IDEAS_SFTP_PROXY_PORT = os.getenv("IDEAS_SFTP_PROXY_PORT", "").strip()
IDEAS_SFTP_PROXY_USERNAME = os.getenv("IDEAS_SFTP_PROXY_USERNAME", "")
IDEAS_SFTP_PROXY_PASSWORD = os.getenv("IDEAS_SFTP_PROXY_PASSWORD", "")
